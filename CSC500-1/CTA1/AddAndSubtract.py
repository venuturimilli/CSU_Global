...
print('Enter number 1 to add/substract : ', end=' ') #Ask User to enter value 1
text = "Number 1" #set text - input Values for function
method = "add/substract" #set method - input Values for function
num1 = my_function(input(), text, method) #Call function to check entered value is an integer
print('Enter number 2 to add/substract : ', end=' ') #Ask User to enter value 2
