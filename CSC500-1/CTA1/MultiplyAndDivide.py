...
method = "Multiply/Divide" #set method - input Values for function
num1 = my_function(input(), text, method) #Call function to check entered value is an integer
print('Enter number 2 to Multiply/Divide : ', end=' ') #Ask User to enter value 2
...
_product = num1 * num2 #Multiplication
print('Product of', end=' ') # Print total
print(num1, end=' and ')
print(num2, end=' = ')
print(_product)
_Quoitient = num1/ num2 #Divide
